...
def main():
    ...
    if host == 'car.com:5000':
        return make_response(render_template("03_car_com_cname.html"))
    elif host == 'news.com:5000':
        return make_response(render_template("03_news_com_cname.html"))
    elif host == 'banner.com:5000' or host == 'banner.car.com:5000' or host == 'banner.news.com:5000':
        referer_history = request.cookies.get('referer_history')
        if referer_history == 'https://car.com:5000/':
            response = send_file('banners/banner_car.jpeg', mimetype='image/jpg')
        else:
